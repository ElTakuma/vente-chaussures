...
if (mysqli_query($connexion, $sql)){
    ...
    $_SESSION['update_success_message'] = "Mise à jour de l'article éffectuer avec succès";
    header("Location:/chaussure/pages/chaussure-detail.php?id=". $id);
    exit();
} else {
    $_SESSION['update_error_message'] = "une érreur est survenu lors de la mise à jour de l'article";
    header("Location:". $_SESSION['redirect_if_update_error']);
    exit();
}
